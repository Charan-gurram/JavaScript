...
const pwpattern = /^(?=.*[A-Z])(?=.*[a-z])(?=.*[0-9])(?=.*[@#$.]).{8,12}$/;
...
{
    msg.textContent = "Password must be A,a,1,@ and 8-12 charactres";
    msg.style.color="red";
    return;
}
if(cfpwd.value!==pwd.value)
{
     msg.textContent = "Password must be same";
    msg.style.color="red";
    return;
}
